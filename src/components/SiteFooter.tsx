    ...
    <footer className="border-t border-terminal-border bg-terminal-surface/30">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-5 sm:py-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          <p className="text-[0.6rem] sm:text-[0.7rem] font-mono text-terminal-muted text-center sm:text-left">
          ...
          <nav className="flex flex-wrap justify-center gap-3 sm:gap-5 text-[0.6rem] sm:text-[0.7rem] font-mono text-terminal-muted">
            {[
        ...
        <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-terminal-border/30 flex flex-col sm:flex-row items-center justify-between gap-2 text-terminal-muted/40 text-[8px] sm:text-[9px] font-mono">
